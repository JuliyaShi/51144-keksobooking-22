...
import {setActiveStatePage , formAddress} from './form.js';
...
export const DefaultCoords = {
  lat: COORDS_MAIN.lat.toFixed(FRACTION_DIGITS_AT_COORDS),
  lng: COORDS_MAIN.lng.toFixed(FRACTION_DIGITS_AT_COORDS),
};
